...
sub HTTP_Response($$;$) {
	...
	if ($connect_refused) {
		...
		$info = 'Please contact the <a href="mailto:weidongx.sun@intel.com">author</a> to report about this error.<br />See the <a href="/get.pl?file='.$LOG_FILE.'" target="_blank">server log file</a> for details.';
	}
